...
var client = require('../routes/datamysql')
...
exports.TESTArchiveForm = function(id) { 
  return exports.actionForm(id, 'datamysql/archive', 'Archive');
}

exports.TESTDeleteForm = function(id) { 
  return exports.actionForm(id, 'datamysql/delete', 'Delete');
}
*/
